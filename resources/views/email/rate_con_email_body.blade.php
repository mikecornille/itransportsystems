...
<p class="ten_requirements"><b>1. PERSONAL PROTECTIVE EQUIPMENT (PPE) REQUIRES THAT DRIVERS MUST HAVE A LONG SLEEVE SHIRT, LONG PANTS, STEEL TOED BOOTS, SAFETY VEST, SAFETY GLASSES, AND HARD HAT ON THEIR PERSON WHEN ON SITE.  FAILURE TO ARRIVE ON SITE PRE-DRESSED WITH ALL PPE WILL RESULT IN A $250.00 FINE.</b></p>

<p class="ten_requirements">2. DRIVERS MUST CONDUCT THEMSELVES IN A PROFESSIONAL MANNER AND MUST AVOID ANY CONFLICT OR DEBATE WITH THE SHIPPER AND RECEIVER.  IF ANY SITUATION ARISES THE DRIVER IS TO CALL 630-832-6900 IMMEDIATELY.</p>

<p class="ten_requirements">3. DRIVERS MUST CONFIRM THEY LOADED THE SPECIFIED COMMODITY DESCRIPTION, PIECE COUNT, AND IDENTIFYING NUMBERS.  IF THERE IS A DISCREPANCY CALL 630-832-6900.</p>

<p class="ten_requirements">4. DRIVERS MUST SECURE THE LOAD PER THE SHIPPERS INSTRUCTIONS FOR SAFE AND SECURE TRANSPORT.  MINIMUM OF 1 CHAIN FOR EVERY 5,000LBS OF EQUIPMENT UNLESS OTHERWISE SPECIFIED.  TRAILER MUST NOT HAVE BROKEN FLOOR BOARDS.</p>

<p class="ten_requirements">5. DRIVERS MUST MAKE SURE THEY ARE LEGAL HEIGHT BEFORE LEAVING SHIPPER.  IF OVER-HEIGHT PLEASE CALL 630-832-6900.</p>

<p class="ten_requirements">6. IF THE INSTRUCTIONS ON INTERNATIONAL TRANSPORT SYSTEMS RATE CONFIRMATION CONFLICTS WITH THE INSTRUCTIONS ON THE SHIPPERS BILL OF LADING, CONTACT THE BROKER IMMEDIATELY AT 630-832-6900.  DO NOT LEAVE SHIPPER UNTIL DISCREPANCY IS RESOLVED.</p>

<p class="ten_requirements">7. ALL RATES AGREED UPON BY INTERNATIONAL TRANSPORT SYSTEMS AND THE CARRIER ARE CONFIDENTIAL AND NOT TO BE DISCUSSED WITH OTHER COMPANIES OR DRIVERS.</p>

<p class="ten_requirements">8. DOUBLE BROKERING AND SOLICITING THE SHIPPER ARE PROHIBITED.</p>

<p class="ten_requirements">9. CARRIER AGREES THE DRIVER HAS ENOUGH HOURS TO MEET TIME FRAME SPECIFIED ON THE RATE CONFIRMATION AND FMCSA HOURS REGULATIONS.</p>

<p class="ten_requirements">10. ALL ACCESSORIAL CHARGES MUST BE PRE APPROVED BY INTERNATIONAL TRANSPORT SYSTEMS.  WAITING TIME WILL NOT BE APPROVED IF THE CARRIER ARRIVES LATE TO THE SHIPPER OR CONSIGNEE.</p>
