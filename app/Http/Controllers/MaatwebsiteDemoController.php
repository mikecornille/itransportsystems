...
class MaatwebsiteDemoController extends Controller
{
	...
	$loads = Load::select('id', 'pick_city', 'pick_state', 'delivery_city', 'delivery_state', 'customer_name', 'customer_id', 'amount_due', 'carrier_name', 'carrier_rate', 'carrier_contact', 'carrier_email', 'carrier_phone', 'pick_date', 'pick_status', 'delivery_date', 'delivery_status', 'billed_date')->where('delivery_status', 'Delivered')->whereNull('billed_date')->orWhere('billed_date', '')->where('pick_status', '!=', 'Cancelled')->where('pick_status', '!=', 'TONU')->orderBy('id', 'asc')->get();
